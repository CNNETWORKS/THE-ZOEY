...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002216202218') # support group id ( make sure bot is admin )
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002197600798') # request channel id ( make sure bot is admin )
